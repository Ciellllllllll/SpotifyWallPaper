/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8663bb7707ae991010ac0f9e6ea2048d)
// Runtime types generated with workerd@1.20260730.1 2026-07-18
interface __BaseEnv_Env {
	DB: D1Database;
	DELETION_DB: D1Database;
	METRICS: AnalyticsEngineDataset;
	AUTH_RATE_LIMITER: RateLimit;
	PLAYBACK_RATE_LIMITER: RateLimit;
	CONTROL_RATE_LIMITER: RateLimit;
	PRE_AUTH_RATE_LIMITER: RateLimit;
	ENVIRONMENT: "preview" | "production" | "development";
	PUBLIC_BASE_URL: "https://replace-preview-before-deploy.example" | "https://replace-production-before-deploy.example" | "http://127.0.0.1:8787";
	TOKEN_ENCRYPTION_KEYRING: string;
	TOKEN_ENCRYPTION_ACTIVE_KEY_ID: string;
	PAIRING_HMAC_KEYRING: string;
	PAIRING_HMAC_ACTIVE_KEY_ID: string;
...
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		PRE_AUTH_RATE_LIMITER: RateLimit;
		ENVIRONMENT: "preview";
		PUBLIC_BASE_URL: "https://replace-preview-before-deploy.example";
		TOKEN_ENCRYPTION_KEYRING: string;
		TOKEN_ENCRYPTION_ACTIVE_KEY_ID: string;
		PAIRING_HMAC_KEYRING: string;
		PAIRING_HMAC_ACTIVE_KEY_ID: string;
	...
	interface ProductionEnv {
		...
		PUBLIC_BASE_URL: "https://replace-production-before-deploy.example";
		TOKEN_ENCRYPTION_KEYRING: string;
		TOKEN_ENCRYPTION_ACTIVE_KEY_ID: string;
		PAIRING_HMAC_KEYRING: string;
		PAIRING_HMAC_ACTIVE_KEY_ID: string;
