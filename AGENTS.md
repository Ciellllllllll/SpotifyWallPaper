...
The public Spotify proxy has been retired. Standard authorization uses the static GitHub Pages PKCE helper and Wallpaper Engine connects directly to Spotify. Keep the optional loopback Rust backend, Tauri configurator, and Rainmeter integration. Reject all public HTTPS backend origins; do not reintroduce hosted proxy infrastructure without a separately approved design.
