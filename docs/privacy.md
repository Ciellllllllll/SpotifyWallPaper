...
## Optional legacy public backend

The following retained backend-specific terms do not describe standard direct
credential storage or require a VPS for ordinary use.
